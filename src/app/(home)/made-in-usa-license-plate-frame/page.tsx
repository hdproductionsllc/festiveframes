...
const META_DESCRIPTION =
  "License plate frames made in the USA - designed by you, handmade to order in St. Louis, MO. Snap-on patriotic tiles, a custom phrase, $39, ships fast.";
...
function buildJsonLd() {
  ...
  const product = {
    "@type": "Product",
    "@id": `${PAGE_URL}#product`,
    name: "License Plate Frame Made in the USA",
    description: META_DESCRIPTION,
