...
const META_DESCRIPTION =
  "Build a red, white and blue license plate frame from snap-on tiles - flags, stars, fireworks - plus your own phrase. $39, handmade in the USA.";
...
function buildJsonLd() {
  ...
  const product = {
    "@type": "Product",
    "@id": `${PAGE_URL}#product`,
    name: "Red, White & Blue License Plate Frame",
    description: META_DESCRIPTION,
