...
describe("school spirit set", () => {
  ...
  it("leads the palette with the real high-school art", () => {
    ...
    // The whole library, one make: 65 die-struck enamel badges. The six flat originals that used to pad this out
    ...
    // ministry, culinary, agriculture, scouting). Agriculture and scouting are
